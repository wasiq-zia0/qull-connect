"""deposit-recovery pricing and shared Stripe billing.
...
FEE_DISCLOSURE = '25% of the deposit you confirm receiving. No recovery, no fee.'
...
def contingency_cents(amount_recovered: float) -> int:
    return percent_cents(amount_recovered, "0.25")
