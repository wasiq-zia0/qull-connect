"""class-action-cash pricing and shared Stripe billing.
...
FEE_DISCLOSURE = '20% of settlement money you confirm receiving. No payout, no fee.'
...
def fee_cents(amount: float) -> int:
    return percent_cents(amount, "0.20")
