...
def main():
    ...
    parser.add_argument("--rest-port", type=int, default=int(os.environ.get("REST_PORT", os.environ.get("DEPOSIT_REST_PORT", "8476"))))
    parser.add_argument("--mcp-port", type=int, default=int(os.environ.get("MCP_PORT", os.environ.get("DEPOSIT_MCP_PORT", "8576"))))
