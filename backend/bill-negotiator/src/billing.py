"""bill-negotiator pricing and shared Stripe billing.
...
FEE_DISCLOSURE = '35% of documented savings over the agreed period, capped at 12 months. You must confirm the fee before payment.'
...
def fee_cents(documented_savings: float) -> int:
    return percent_cents(documented_savings, "0.35")
